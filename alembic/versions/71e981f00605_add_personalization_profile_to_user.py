...
Revision ID: 71e981f00605
Revises: ef4d50af0795
Create Date: 2025-11-08 11:00:03.483651
...
revision: str = '71e981f00605'
down_revision: Union[str, Sequence[str], None] = 'ef4d50af0795'
...
def downgrade() -> None:
    ...
    sa.Column('report_html', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('user_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('profile_data', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('personalization_profiles_user_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('personalization_profiles_pkey'))
    )
